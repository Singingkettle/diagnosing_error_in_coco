...
drawline = true;
makeMultiCategoryPlot(1, results_all, 'area', [titlename ': BBox Area'], 1, {'XS', 'S', 'M', 'L', 'XL'}, drawline);
makeMultiCategoryPlot(2, results_all, 'height', [titlename ': BBox Height'], 1, {'XS', 'S', 'M', 'L', 'XL'}, drawline);
makeMultiCategoryPlot(3, results_all, 'aspect', [titlename ': Aspect Ratio'], 1, {'XT', 'T', 'M', 'W', 'XW'}, drawline);
